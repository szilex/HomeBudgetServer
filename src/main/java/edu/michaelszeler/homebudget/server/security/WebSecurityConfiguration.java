package edu.michaelszeler.homebudget.server.security;

import edu.michaelszeler.homebudget.server.service.implementation.DefaultUserDetailsService;
...
import static edu.michaelszeler.homebudget.server.security.SecurityConstants.SIGN_UP_URL;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.DELETE, "/strategy").fullyAuthenticated()
                ...
                .antMatchers(HttpMethod.DELETE, "/expense").fullyAuthenticated()
